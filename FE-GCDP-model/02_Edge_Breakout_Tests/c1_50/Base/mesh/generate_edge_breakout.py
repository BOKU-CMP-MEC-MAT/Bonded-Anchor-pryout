...
# Concrete Slab
edge_dist = 50.0     # Distance from anchor center to the free edge (+x direction)
nearfield_x = 150.0  # Total length (x)
...
band_x = 50.0e2               # Thickness of the solid refined block in front of the anchor (x-dir)
band_y = 15.0e2               # Thickness of the refined shell from the top surface (y-dir)
band_z = 20.0e2               # Thickness of the refined shell from the symmetry plane (z-dir)
