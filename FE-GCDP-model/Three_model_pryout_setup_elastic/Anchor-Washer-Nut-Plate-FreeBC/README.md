# Anchor-Washer-Nut-Plate-FreeBC

Variant of `../Anchor-Washer-Nut-Plate` (anchor + plate + washer + nut, shaft/hole contact with 0.5 mm clearance).
...
`../Pryout_anchorwashernut`. `mesh/concrete.inp` is identical to that case's;
...
plate of `Anchor-Washer-Nut-Plate`; that was wrong and has been regenerated with
`mesh/Pryout_elastic_anchorwashernut.py`.
